...
Analyzes wallet activity and transaction history on the Base network.

Parameters:

- `walletAddress`: The address of the wallet to analyze (optional, uses your wallet if not provided)
- `transactionLimit`: Maximum number of recent transactions to analyze (optional, defaults to 10)

Example query to Claude:

> "Analyze my wallet activity on Base."
> "Show me transaction analytics for wallet 0x1234567890abcdef1234567890abcdef12345678."
